...
const TableBody = () => {
  const data = [
    ...
    },
    {
      name: "Thông điệp bí ẩn từ vũ trụ",
      price: 5483,
      description: "Dở ẹc đọc thấy gớm ai mà thèm đọc má Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, ea corrupti molestiae ducimus aliquam nihil excepturi vero porro quae non quia earum incidunt sequi provident illum enim, voluptas commodi! Ut?",
      active: false,
    },
    {
      name: "Thông điệp bí ẩn từ vũ trụ",
